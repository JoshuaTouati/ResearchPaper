...
#envm = gym.wrappers.Monitor(env, '/tmp/video', video_callable=lambda x: True, force=True)
...
if __name__=="__main__":
    ...
    if record_video:
        ...
        env = Monitor(env, './Documents/VU/Research Paper/videos/', video_callable=lambda x: True, force=True)
    isopen = True
    while isopen:
        env.reset()
        total_reward = 0.0
